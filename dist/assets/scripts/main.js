(function () {
  ...
  function append$2(parent, children) {
    ...
    slice$1(arguments, 1).forEach(function (source) {
      forOwn(source, function (value, key) {
        if (isArray(value)) {
          ...
          object[key] = merge$1({}, isObject(object[key]) ? object[key] : {}, value);
        } else {
          object[key] = value;
        }
      });
  ...
  function setAttribute(elms, attrs, value) {
    if (isObject(attrs)) {
      ...
      forEach(elms, function (elm) {
        isNull(value) || value === "" ? removeAttribute$1(elm, attrs) : elm.setAttribute(attrs, String(value));
      });
    }
  }
  ...
  function Elements(Splide2, Components2, options) {
    ...
    function find(selector) {
      ...
      return elm && closest$1(elm, "." + CLASS_ROOT) === root ? elm : void 0;
    }
    ...
    function add(items, index) {
      forEach(items, function (slide) {
        ...
        if (isHTMLElement(slide)) {
          ...
          ref ? before$1(slide, ref) : append$2(list, slide);
    ...
    function generate(count) {
      ...
      if (length) {
        ...
        push(slides.slice(-count), slides.slice(0, count)).forEach(function (Slide, index) {
          ...
          isHead ? before$1(clone, slides[0].slide) : append$2(Elements.list, clone);
          push(clones, clone);
  ...
  function Arrows(Splide2, Components2, options) {
    ...
    function createArrows() {
      ...
      created = true;
      append$2(wrapper, [prev, next]);
      !placeholder && before$1(wrapper, track);
    }
  ...
  function Pagination(Splide2, Components2, options) {
    ...
    function destroy() {
      if (list) {
        remove$1(placeholder ? slice$1(list.children) : list);
  ...
  var _Splide = /*#__PURE__*/function () {
    ...
    _proto.emit = function emit(event) {
      ...
      (_this$event = this.event).emit.apply(_this$event, [event].concat(slice$1(arguments, 1)));
  ...
  class DomHandler {
      ...
      onopentag(name, attribs) {
          ...
          const element = new Element$1(name, attribs, undefined, type);
  ...
  const adapter = {
      ...
      createElement(tagName, namespaceURI, attrs) {
          ...
          const node = new Element$1(tagName, attribs, []);
  ...
  class Review {
  	...
  	updateContent() {
  		if (this.collapsed) {
  			this.body.innerHTML = $13b04019e035f7c9$exports(this.content, this.contentLength);
  			this.button.textContent = 'Развернуть';
  		} else {
  			this.body.innerHTML = $13b04019e035f7c9$exports(this.content, Infinity);
  ...
  window.addEventListener('DOMContentLoaded', () => {
  	...
  	Oe.bind('[data-fancybox="about-gallery"]');
  	Oe.bind('[data-fancybox="case-gallery"]');
